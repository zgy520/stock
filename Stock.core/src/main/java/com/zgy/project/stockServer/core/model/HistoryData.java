...
public class HistoryData extends BaseModel {
    ...
    public HistoryData(String name, String code, Date stockDate, BigDecimal  startPrice, BigDecimal  endPrice, BigDecimal  range, String rangeRate, BigDecimal  minPrice, BigDecimal  maxPrice, Integer volumn, BigDecimal  turnOverSum, String turanOverRate) {
        this.stockName = name;
        this.stockCode = code;
